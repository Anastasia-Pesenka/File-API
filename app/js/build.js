...
define('fb',['module', 'firebase', 'radio'],
...
define('modules/toDoList',['underscore', 'radio', 'fb', 'util', 'text!templates/toDoList.html'],
    function (_, radio, fb, util, toDoTpl) {
        return {
            ...
            setupEvents: function () {
                radio.on('auth/changed', this.changeAuth.bind(this));
                radio.on('tasksGot', this.updateTasks.bind(this));
...
define('text!templates/settings.html',[],function () { return '<% if(user) {%>\r\n<input type="file" id="input">\r\n<% } %>\r\n\r\n';});

define('modules/settings',['underscore', 'radio', 'text!templates/settings.html', 'fb'],
...
define('app',['fb', 'radio', 'modules/menu', 'modules/toDoList', 'modules/settings'],
